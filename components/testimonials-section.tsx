      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.3]">
            When I’m not
            <br />
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">coding</span>
          </h2>
          {/* <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto pb-8">
           I enjoy video editing, exploring UI/UX design research, and playing video games. These activities help me sharpen my visual sense, understand user behavior, and stay creatively engaged.
          </p> */}
        </div>
            ...
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                <p className="text-sm md:text-base lg:text-lg mb-6 leading-relaxed">
                  I enjoy understanding how users think and interact with interfaces. Whether I’m editing videos, exploring UI/UX research, or playing games, I’m always observing design decisions and learning what makes experiences engaging
                </p>

                <div>
                  <div className="font-bold text-base md:text-lg">Sneha Suresh</div>
                  <div className="text-gray-600 text-sm md:text-base">3rd year CSE student</div>
                </div>
              </div>
            </div>
